    ...
    return (
        <div>
            <div className="info-container">
                ...
                {/*<img className='weather' src={`http://api.openweathermap.org/img/wn/${weather.weather[0].icon}.png`} width='50px' height='50px' alt="Temp" /> */}
                <svg
                    className="weather"
                    version="1.1"
                    id="Layer_1"
                ...
                <div className="info-container-content">
                    <div className="feels-like-container">
                        <p className="feels-like-text">Sensação Térmica</p>
                        <p className="feels-like-data">{Math.round(weather.main.feels_like)}&deg;</p>
                    </div>
                    <div className="wind-container">
                        <p className="wind-text">Vento</p>
                        <p className="wind-data">{weather.wind.speed}km/h</p>
                    </div>
                    <div className="humidity-container">
                        <p className="humidity-text">Umidade</p>
                        <p className="humidity-data">{weather.main.humidity}%</p>
                    </div>
                </div>
            </div>
        </div>
